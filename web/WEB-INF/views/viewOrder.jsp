                ...
                <div class="section_container">
                    ...
                    <table border="1" id="bootstrap-data-table-Login" class="table table-striped table-bordered">
                        <thead class="thead-dark">
                            ...
                            <tbody>
                                <c:forEach var="u" items="${listViewOrder}">
                                    <tr>

                                        <td class="hidden-xs" align="center">${u.maDH}</td>
                                        ...
                                        <c:choose>
                                            <c:when test="${u.trangthai == 1}">
                                                <td align="center"><span class="badge badge-success">Đã hoàn thành</span></td>

                                            </c:when>
                                            <c:otherwise>
                                                <td align="center"><span class="badge badge-warning">Chưa hoàn thành</span></td>
                                            </c:otherwise>
