<%-- 
    Document   : checkout
    Created on : Oct 18, 2020, 12:26:26 PM
    Author     : HOME
--%>
...
<html lang="en">
    <head>
        <title>Checkout - Bùi Ngọc Thành - PS10511</title>
        <meta charset="utf-8">
                                ...
                                <div class="checkout_container d-flex flex-xxl-row flex-column align-items-start justify-content-start">
                                    ...
                                    <div class="billing checkout_box">
                                        <div class="cart_total_inner checkout_box">
                                            <div class="checkout_title">Status Order: ${messageCheckOut}</div>
                                            
                                            <br>
                                            <form method="post" action="${pageContext.request.contextPath }/admin/verifyAddress.html">
                                                <input class="form-control" id="maDH" name="maDH" value="${maDH}" hidden="true">
                                                Địa chỉ: (Bạn có thể bỏ trống, chúng tôi sẽ gọi xác nhận địa chỉ một lần nữa)
                                                <input class="form-control" id="address" name="address" placeholder="Địa chỉ nhận hàng"><br>
                                                <input class="checkout_button trans_200" value="Xác nhận đặt hàng" type="submit">
                                            </form>

                                            

                                            <!-- Order Text -->
                                            <div class="order_text">Đơn hàng của bạn sẽ được giao sau khi chúng tôi xác nhận. Bạn có thể cập nhật địa chỉ hoặc chúng tôi sẽ xác nhận một lần nữa.</div>
