<%-- 
    Document   : cart
    Created on : Oct 18, 2020, 11:14:21 AM
    Author     : HOME
--%>
...
<html lang="en">
<head>
	<title>Cart - Bùi Ngọc Thành - PS10511</title>
	<meta charset="utf-8">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				<li class="menu_mm"><a href="index.html">home<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
						<%
							if (session.getAttribute("vaitro").equals(1)) {
								out.print("<li class='menu_mm'><a href='admin/index.html'>Quản Lý Tài Khoản<i class='fa fa-users' aria-hidden='true'></i></a></li>");
								out.print("<li class='menu_mm'><a href='admin/sanpham.html'>Quản Lý Sản Phẩm<i class='fa fa-cogs' aria-hidden='true'></i></a></li>");
								out.print("<li class='menu_mm'><a href='admin/donhang.html'>Quản Lý Đơn Hàng<i class='fa fa-database' aria-hidden='true'></i></a></li>");
								out.print("<li class='menu_mm'><a href='admin/danhmuc.html'>Quản Lý Danh Mục<i class='fa fa-clone' aria-hidden='true'></i></a></li>");

							}
						%>
				 <li class="menu_mm"><a href="viewOrder.html">View Order<i class="fa fa-gift" aria-hidden="true"></i></a></li>

				<li class="menu_mm"><a href="cart.html">View Carts<i class="fa fa-shopping-cart" aria-hidden="true"></i></a></li>
				<li class="menu_mm"><a href="login/logout.html">Logout<i class="fa fa-sign-out" aria-hidden="true"></i></a></li>
				...
				<div class="row">
					<div class="col">
						<div class="cart_container">
							${messageAddToCart}
                                                        <% session.removeAttribute("messageAddToCart"); %>
							<!-- Cart Bar -->
							<div class="cart_bar">
								...
								<ul class="cart_items_list">
									...
									<li class="cart_item item_list d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
										...
										<div class="product_total text-lg-center product_text"><span>Total: </span>$19.50</div>
                                                                        ...
                                                                        <c:forEach var="o" items="${listCartOrder}">
                                                                        <!-- Cart Item -->
                                                                        <li class="cart_item item_list d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
										<div class="product d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
											<div><div class="product_image"><img src="images/${o.sanpham.hinh}" alt=""></div></div>
											<div class="product_name"><a href="product.html?maSP=${o.sanpham.maSP}">${o.sanpham.tenSP}</a></div>
										</div>
										<div class="product_color text-lg-center product_text"><span>Type: </span>${o.sanpham.type}</div>
										<div class="product_size text-lg-center product_text"><span>Size: </span>One Size</div>
										<div class="product_price text-lg-center product_text"><span>Price: </span>$${o.sanpham.donGia}</div>
										<div class="product_quantity_container">
											<div class="product_quantity ml-lg-auto mr-lg-auto text-center">
												<span>${o.soluong}</span>
                                                                                                <a href="UpandDownProduct.html?type=2&maSP=${o.sanpham.maSP}"><div class="qty_sub qty_button trans_200 text-center"><span>-</span></div></a>
                                                                                                <a href="UpandDownProduct.html?type=1&maSP=${o.sanpham.maSP}"><div class="qty_add qty_button trans_200 text-center"><span>+</span></div></a>
											</div>
										</div>
										<div class="product_total text-lg-center product_text"><span>Total: </span>$${(o.soluong*o.sanpham.donGia)}</div>
									</li>
                                                                        </c:forEach>
								</ul>
							</div>
							...
							<div class="cart_buttons d-flex flex-row align-items-start justify-content-start">
								<div class="cart_buttons_inner ml-auto d-flex flex-row align-items-start justify-content-start flex-wrap">
									...
									<div class="button button_clear trans_200"><a href="cartRemoveAll.html">clear cart</a></div>
									<div class="button button_update trans_200"><a href="cart.html">update cart</a></div>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="cart_extra_content cart_extra_total">
								...
								<ul class="cart_extra_total_list">
									<li class="d-flex flex-row align-items-center justify-content-start">
										...
										<div class="cart_extra_total_value ml-auto">$${tongtienCart}</div>
									</li>
									<li class="d-flex flex-row align-items-center justify-content-start">
									...
									<li class="d-flex flex-row align-items-center justify-content-start">
										...
										<div class="cart_extra_total_value ml-auto">$${tongtienCart}</div>
                                                                        ...
                                                                        <div class="checkout_button trans_200"><a href="checkoutProcess.html">proceed to checkout</a></div>
							</div>
						</div>
					</div>
				</div>
